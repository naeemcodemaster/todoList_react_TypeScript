...
export default function AddTodoForm({onSubmit}: AddTodoFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-4 mb-4">
            <input type="text" value={inputValue} onChange={(e)=>setInputValue(e.target.value)} className="border border-gray-300 rounded-lg p-2 w-full" placeholder="Add a new todo" />
